...
nicholas = [  
    ...
    const player = new Player({ 
        collisionBlocks,
        imageSrc: '../Sprites/p2_idleRight.png',
        frameRate: 12,
        animations: {
            idleRight: {
                frameRate: 12,
            ...
            idleLeft: {
                ...
                frameBuffer: 5.5/2,
                loop: true,
                imageSrc: "../Sprites/p2_idleLeft.png",
            },
            walkRight: {
                frameRate: 12,
                frameBuffer: 2/2,
                loop: true,
                imageSrc: "../Sprites/p2_walkRight.png",
            },
            walkLeft: {
                frameRate: 12,
                frameBuffer: 2/2,
                loop: true,
                imageSrc: "../Sprites/p2_walkLeft.png",
            },
            dashRight: {
                frameRate: 3,
                frameBuffer: 4/2,
            ...
            crouchRight: {
                ...
                frameBuffer: 20/2,
                loop: true,
                imageSrc: '../Sprites/p2_crchRight.png'
            },
            crouchLeft: {
                frameRate: 2,
                frameBuffer: 2/2,
                loop: true,
                imageSrc: '../Sprites/p2_crchLeft.png'
            },
            jumpRight: {
                frameRate: 36,
                frameBuffer: 2,
                loop: false,
                imageSrc: '../Sprites/p2_chargeFullRight.png'
            },
            jumpLeft: {
                frameRate: 36,
                frameBuffer: 2,
                loop: false,
                imageSrc: '../Sprites/p2_chargeFullLeft.png'
            },
            jumpFullRight: {
                frameRate: 12,
                frameBuffer: 5/2,
                loop: true,
                imageSrc: '../Sprites/p2_chargeRight.png'
            },
            jumpFullLeft: {
                frameRate: 12,
                frameBuffer: 5/2,
                loop: true,
                imageSrc: '../Sprites/p2_chargeLeft.png'
            },
            playerData: {
                frameRate: 12,
                frameBuffer: 7/2,
                loop: false,
                imageSrc: '../Sprites/p2_data.png',
                onComplete: () => {
                    gsap.to(overlay, {
                        opacity: 1,
                        onComplete: () => {
