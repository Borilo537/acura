    ...
    switch (event.key) {
        ...
        case 'Shift':
            ...
            if (level >= 2) {
                ...
                if (player.lastDirection == 'left' && dash == true) {
                    keys.ShiftL.pressed = true, background.position.x = 15,
                        setTimeout(function () {
                            keys.ShiftL.pressed = false, dash = false, background.position.x = 0
                        }, delay),
                        setTimeout(function () {
                            dash = true
                        }, bigdelay)
                ...
                else if (player.lastDirection == 'right' && dash == true) {
                    keys.ShiftR.pressed = true, background.position.x = -15,
                        setTimeout(function () {
                            keys.ShiftR.pressed = false, dash = false, background.position.x = 0
                        }, delay),
                        setTimeout(function () {
                            dash = true
                        }, bigdelay)
...
window.addEventListener('keyup', (event) => {
    ...
    switch (event.key) {
        ...
        case ' ':
            ...
            setTimeout(function () {
                jumpFrame = false, FullJump = false
            }, delay)

            if (player.velocity.y === 0 && jump > 0 && jump < 20) {
                player.velocity.y = -12 - 22,
                    document.body.style.backgroundColor = 'black'
                setTimeout(function () {
                    jump = 0
                }, delay)
            ...
            else if (player.velocity.y === 0 && jump > 20 && jump < 50) {
                player.velocity.y = -17.5 - 25,
                    document.body.style.backgroundColor = 'black'
                setTimeout(function () {
                    jump = 0
                }, delay)
            ...
            else if (player.velocity.y === 0 && jump > 50) {
                player.velocity.y = -27.5 - 41, background.position.x = 30
                document.body.style.backgroundColor = 'black'
                setTimeout(function () {
                    jump = 0, background.position.x = -15, setTimeout(function () { background.position.x = 0 }, delay)
                }, delay)
            }
            break
